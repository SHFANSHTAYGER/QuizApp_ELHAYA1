...
public class Qst4 extends AppCompatActivity {
    RadioGroup rg;
    RadioButton rb;
    Button bNext;
    int score;
    String RepCorrect;
    private static final String TAG = "quiz4";
        ...
        bNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(rg.getCheckedRadioButtonId()==-1){
                    ...
                    Intent intent=new Intent(Qst4.this,Qst5.class);
        ...
        db.collection("questions")
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        if (document.exists()) {
                            RepCorrect = document.getString("Qst4.answer");
